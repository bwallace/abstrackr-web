...
./<a href="/abstrackr${url(controller='account', action='welcome')}">dashboard</a>
          /<a href="/abstrackr${url(controller='review', action='show_review', id=c.review_id)}">${c.review_name}</a>
</div>
