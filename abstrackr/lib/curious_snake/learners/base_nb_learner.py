...
class BaseNBLearner(BaseLearner):
    ...
    '''
    def __init__(self, unlabeled_datasets, models=None, undersample_before_eval=True):
    ...
    def _datasets_to_matrices(self, datasets):
	    ...
	    for dimensionality, dataset in zip(dims, datasets):
	        ...
	        for i,instance in enumerate(dataset.instances.values()):
	            cur_inst = []
    ...
    def rebuild_models(self, for_eval):
    ...
    def predict(self, x):
        ...
        return self.models[0].predict(x.point)
