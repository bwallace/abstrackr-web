...
<div id="dialog-confirm" title="Acknowledge project deletion.">
    <h2>important!</h2>
    <p>projects that are merged will be removed.</p>
    <p>only the the newly created merged project will remain.</p>
    <p>please confirm that you wish to proceed with the merge.</p>
</div>
            ...
            ${h.form(url(controller='review', action='merge_reviews'), multipart=True, id="merge_review_form",  method='post')}
                ...
                <div class="actions">
                    <tr>
                        <td></td>
                        <td></td>
                        <td><button id='submit-button'>merge review</button></td>
                        <!--
                        <td class="actions">
                            ${h.submit('post', 'merge reviews')}
                        </td>
                        -->
                    </tr>
                </div>
